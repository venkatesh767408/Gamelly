  ...
  return (
    ...
    >
      ...
      <div className="mt-7 lg:flex items-center justify-between gap-10">
        <img src="/volleyball2.webp" alt="" className="lg:h-[500px] rounded-xl" />
        <div className="mt-5 ">
      ...
      <div className="mt-7 lg:flex items-center justify-between gap-10">
        ...
        <img src="/volleyball1.webp" alt="" className="md:h-[500px] lg:h-[500px] xl:h-[500px] 2xl:h-[400px] mt-5 md:mt-0 rounded-xl" />
      </div>
