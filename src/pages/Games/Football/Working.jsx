  ...
  return (
    ...
    >
      ...
      <div className="mt-7 lg:flex items-center justify-between gap-10">
        <img src="footballtiger.webp" alt="" loading="lazy"  className="lg:h-[500px] rounded-xl" />
        <div className="mt-5 ">
      ...
      <div className="mt-7 lg:flex items-center justify-between gap-10">
        ...
        <img src="footballbird.webp" alt="" loading="lazy"  className="md:h-[400px] lg:h-[300px] xl:h-[400px] 2xl:h-[400px] mt-5 md:mt-0 rounded-xl" />
      </div>
